...
<title>socket.io | Teacher 2.0</title>
...
<link rel="canonical" href="http://localhost:4100/Multiplayer/node_backend/node_modules/socket.io/" />
<meta property="og:url" content="http://localhost:4100/Multiplayer/node_backend/node_modules/socket.io/" />
<meta property="og:site_name" content="Teacher 2.0" />
<meta property="og:type" content="website" />
<meta name="twitter:card" content="summary" />
<meta property="twitter:title" content="socket.io" />
<script type="application/ld+json">
{"@context":"https://schema.org","@type":"WebPage","description":"August 2023 to June 2024","headline":"socket.io","url":"http://localhost:4100/Multiplayer/node_backend/node_modules/socket.io/"}</script>
<!-- End Jekyll SEO tag -->
...
<main class="page-content" aria-label="Content">
  ...
  <header class="post-header">
    <h1 class="post-title">socket.io</h1>
  </header>

  <div class="post-content">
    <h1 id="socketio">socket.io</h1>
<p><a href="https://replit.com/@socketio/socketio-minimal-example"><img src="https://repl.it/badge/github/socketio/socket.io" alt="Run on Repl.it" /></a>
<a href="#backers"><img src="https://opencollective.com/socketio/backers/badge.svg" alt="Backers on Open Collective" /></a> <a href="#sponsors"><img src="https://opencollective.com/socketio/sponsors/badge.svg" alt="Sponsors on Open Collective" /></a>
<a href="https://github.com/socketio/socket.io/actions"><img src="https://github.com/socketio/socket.io/workflows/CI/badge.svg" alt="Build Status" /></a>
<a href="https://www.npmjs.com/package/socket.io"><img src="https://badge.fury.io/js/socket.io.svg" alt="NPM version" /></a>
<img src="https://img.shields.io/npm/dm/socket.io.svg?style=flat" alt="Downloads" />
<a href="https://slackin-socketio.now.sh"><img src="https://slackin-socketio.now.sh/badge.svg" alt="" /></a></p>
...
<ul>
  ...
  <li><a href="https://github.com/ElephantIO/elephant.io">PHP</a></li>
</ul>
...
<h4 id="auto-reconnection-support">Auto-reconnection support</h4>
...
<h4 id="disconnection-detection">Disconnection detection</h4>
...
<p>That functionality is achieved with timers set on both the server and the client, with timeout values (the <code class="language-plaintext highlighter-rouge">pingInterval</code> and <code class="language-plaintext highlighter-rouge">pingTimeout</code> parameters) shared during the connection handshake. Those timers require any subsequent client calls to be directed to the same server, hence the <code class="language-plaintext highlighter-rouge">sticky-session</code> requirement when using multiples nodes.</p>

<h4 id="binary-support">Binary support</h4>
...
<h4 id="simple-and-convenient-api">Simple and convenient API</h4>
...
<div class="language-js highlighter-rouge"><div class="highlight"><pre class="highlight"><code><span class="nx">io</span><span class="p">.</span><span class="nx">on</span><span class="p">(</span><span class="dl">'</span><span class="s1">connection</span><span class="dl">'</span><span class="p">,</span> <span class="nx">socket</span> <span class="o">=&gt;</span> <span class="p">{</span>
  <span class="nx">socket</span><span class="p">.</span><span class="nx">emit</span><span class="p">(</span><span class="dl">'</span><span class="s1">request</span><span class="dl">'</span><span class="p">,</span> <span class="cm">/* … */</span><span class="p">);</span> <span class="c1">// emit an event to the socket</span>
  <span class="nx">io</span><span class="p">.</span><span class="nx">emit</span><span class="p">(</span><span class="dl">'</span><span class="s1">broadcast</span><span class="dl">'</span><span class="p">,</span> <span class="cm">/* … */</span><span class="p">);</span> <span class="c1">// emit an event to all connected sockets</span>
  <span class="nx">socket</span><span class="p">.</span><span class="nx">on</span><span class="p">(</span><span class="dl">'</span><span class="s1">reply</span><span class="dl">'</span><span class="p">,</span> <span class="p">()</span> <span class="o">=&gt;</span> <span class="p">{</span> <span class="cm">/* … */</span> <span class="p">});</span> <span class="c1">// listen to the event</span>
<span class="p">});</span>
</code></pre></div></div>

<h4 id="cross-browser">Cross-browser</h4>
...
<h4 id="multiplexing-support">Multiplexing support</h4>

<p>In order to create separation of concerns within your application (for example per module, or based on permissions), Socket.IO allows you to create several <code class="language-plaintext highlighter-rouge">Namespaces</code>, which will act as separate communication channels but will share the same underlying connection.</p>

<h4 id="room-support">Room support</h4>

<p>Within each <code class="language-plaintext highlighter-rouge">Namespace</code>, you can define arbitrary channels, called <code class="language-plaintext highlighter-rouge">Rooms</code>, that sockets can join and leave. You can then broadcast to any given room, reaching every socket that has joined it.</p>
...
<p><strong>Note:</strong> Socket.IO is not a WebSocket implementation. Although Socket.IO indeed uses WebSocket as a transport when possible, it adds some metadata to each packet: the packet type, the namespace and the ack id when a message acknowledgement is needed. That is why a WebSocket client will not be able to successfully connect to a Socket.IO server, and a Socket.IO client will not be able to connect to a WebSocket server (like <code class="language-plaintext highlighter-rouge">ws://echo.websocket.org</code>) either. Please see the protocol specification <a href="https://github.com/socketio/socket.io-protocol">here</a>.</p>

<h2 id="installation">Installation</h2>

<div class="language-bash highlighter-rouge"><div class="highlight"><pre class="highlight"><code>// with npm
...
HTTP server listening on port <code class="language-plaintext highlighter-rouge">3000</code>.</p>

<div class="language-js highlighter-rouge"><div class="highlight"><pre class="highlight"><code><span class="kd">const</span> <span class="nx">server</span> <span class="o">=</span> <span class="nx">require</span><span class="p">(</span><span class="dl">'</span><span class="s1">http</span><span class="dl">'</span><span class="p">).</span><span class="nx">createServer</span><span class="p">();</span>
<span class="kd">const</span> <span class="nx">io</span> <span class="o">=</span> <span class="nx">require</span><span class="p">(</span><span class="dl">'</span><span class="s1">socket.io</span><span class="dl">'</span><span class="p">)(</span><span class="nx">server</span><span class="p">);</span>
<span class="nx">io</span><span class="p">.</span><span class="nx">on</span><span class="p">(</span><span class="dl">'</span><span class="s1">connection</span><span class="dl">'</span><span class="p">,</span> <span class="nx">client</span> <span class="o">=&gt;</span> <span class="p">{</span>
  <span class="nx">client</span><span class="p">.</span><span class="nx">on</span><span class="p">(</span><span class="dl">'</span><span class="s1">event</span><span class="dl">'</span><span class="p">,</span> <span class="nx">data</span> <span class="o">=&gt;</span> <span class="p">{</span> <span class="cm">/* … */</span> <span class="p">});</span>
  <span class="nx">client</span><span class="p">.</span><span class="nx">on</span><span class="p">(</span><span class="dl">'</span><span class="s1">disconnect</span><span class="dl">'</span><span class="p">,</span> <span class="p">()</span> <span class="o">=&gt;</span> <span class="p">{</span> <span class="cm">/* … */</span> <span class="p">});</span>
<span class="p">});</span>
...
<div class="language-js highlighter-rouge"><div class="highlight"><pre class="highlight"><code><span class="kd">const</span> <span class="nx">io</span> <span class="o">=</span> <span class="nx">require</span><span class="p">(</span><span class="dl">'</span><span class="s1">socket.io</span><span class="dl">'</span><span class="p">)();</span>
<span class="nx">io</span><span class="p">.</span><span class="nx">on</span><span class="p">(</span><span class="dl">'</span><span class="s1">connection</span><span class="dl">'</span><span class="p">,</span> <span class="nx">client</span> <span class="o">=&gt;</span> <span class="p">{</span> <span class="p">...</span> <span class="p">});</span>
...
<h3 id="module-syntax">Module syntax</h3>

<div class="language-js highlighter-rouge"><div class="highlight"><pre class="highlight"><code><span class="k">import</span> <span class="p">{</span> <span class="nx">Server</span> <span class="p">}</span> <span class="k">from</span> <span class="dl">"</span><span class="s2">socket.io</span><span class="dl">"</span><span class="p">;</span>
...
<h3 id="in-conjunction-with-express">In conjunction with Express</h3>

<p>Starting with <strong>3.0</strong>, express applications have become request handler
functions that you pass to <code class="language-plaintext highlighter-rouge">http</code> or <code class="language-plaintext highlighter-rouge">http</code> <code class="language-plaintext highlighter-rouge">Server</code> instances. You need
to pass the <code class="language-plaintext highlighter-rouge">Server</code> to <code class="language-plaintext highlighter-rouge">socket.io</code>, not the express application
function. Also make sure to call <code class="language-plaintext highlighter-rouge">.listen</code> on the <code class="language-plaintext highlighter-rouge">server</code>, not the <code class="language-plaintext highlighter-rouge">app</code>.</p>

<div class="language-js highlighter-rouge"><div class="highlight"><pre class="highlight"><code><span class="kd">const</span> <span class="nx">app</span> <span class="o">=</span> <span class="nx">require</span><span class="p">(</span><span class="dl">'</span><span class="s1">express</span><span class="dl">'</span><span class="p">)();</span>
...
<span class="kd">const</span> <span class="nx">io</span> <span class="o">=</span> <span class="nx">require</span><span class="p">(</span><span class="dl">'</span><span class="s1">socket.io</span><span class="dl">'</span><span class="p">)(</span><span class="nx">server</span><span class="p">);</span>
<span class="nx">io</span><span class="p">.</span><span class="nx">on</span><span class="p">(</span><span class="dl">'</span><span class="s1">connection</span><span class="dl">'</span><span class="p">,</span> <span class="p">()</span> <span class="o">=&gt;</span> <span class="p">{</span> <span class="cm">/* … */</span> <span class="p">});</span>
<span class="nx">server</span><span class="p">.</span><span class="nx">listen</span><span class="p">(</span><span class="mi">3000</span><span class="p">);</span>
</code></pre></div></div>

<h3 id="in-conjunction-with-koa">In conjunction with Koa</h3>

<p>Like Express.JS, Koa works by exposing an application as a request
handler function, but only by calling the <code class="language-plaintext highlighter-rouge">callback</code> method.</p>

<div class="language-js highlighter-rouge"><div class="highlight"><pre class="highlight"><code><span class="kd">const</span> <span class="nx">app</span> <span class="o">=</span> <span class="nx">require</span><span class="p">(</span><span class="dl">'</span><span class="s1">koa</span><span class="dl">'</span><span class="p">)();</span>
<span class="kd">const</span> <span class="nx">server</span> <span class="o">=</span> <span class="nx">require</span><span class="p">(</span><span class="dl">'</span><span class="s1">http</span><span class="dl">'</span><span class="p">).</span><span class="nx">createServer</span><span class="p">(</span><span class="nx">app</span><span class="p">.</span><span class="nx">callback</span><span class="p">());</span>
<span class="kd">const</span> <span class="nx">io</span> <span class="o">=</span> <span class="nx">require</span><span class="p">(</span><span class="dl">'</span><span class="s1">socket.io</span><span class="dl">'</span><span class="p">)(</span><span class="nx">server</span><span class="p">);</span>
<span class="nx">io</span><span class="p">.</span><span class="nx">on</span><span class="p">(</span><span class="dl">'</span><span class="s1">connection</span><span class="dl">'</span><span class="p">,</span> <span class="p">()</span> <span class="o">=&gt;</span> <span class="p">{</span> <span class="cm">/* … */</span> <span class="p">});</span>
<span class="nx">server</span><span class="p">.</span><span class="nx">listen</span><span class="p">(</span><span class="mi">3000</span><span class="p">);</span>
</code></pre></div></div>

<h3 id="in-conjunction-with-fastify">In conjunction with Fastify</h3>

<p>To integrate Socket.io in your Fastify application you just need to
register <code class="language-plaintext highlighter-rouge">fastify-socket.io</code> plugin. It will create a <code class="language-plaintext highlighter-rouge">decorator</code>
called <code class="language-plaintext highlighter-rouge">io</code>.</p>

<div class="language-js highlighter-rouge"><div class="highlight"><pre class="highlight"><code><span class="kd">const</span> <span class="nx">app</span> <span class="o">=</span> <span class="nx">require</span><span class="p">(</span><span class="dl">'</span><span class="s1">fastify</span><span class="dl">'</span><span class="p">)();</span>
<span class="nx">app</span><span class="p">.</span><span class="nx">register</span><span class="p">(</span><span class="nx">require</span><span class="p">(</span><span class="dl">'</span><span class="s1">fastify-socket.io</span><span class="dl">'</span><span class="p">));</span>
<span class="nx">app</span><span class="p">.</span><span class="nx">io</span><span class="p">.</span><span class="nx">on</span><span class="p">(</span><span class="dl">'</span><span class="s1">connection</span><span class="dl">'</span><span class="p">,</span> <span class="p">()</span> <span class="o">=&gt;</span> <span class="p">{</span> <span class="cm">/* … */</span> <span class="p">});</span>
...
<p>Socket.IO is powered by <a href="https://github.com/visionmedia/debug">debug</a>.
...
<div class="language-plaintext highlighter-rouge"><div class="highlight"><pre class="highlight"><code>DEBUG=socket.io* node myapp
</code></pre></div></div>
...
<p>This runs the <code class="language-plaintext highlighter-rouge">gulp</code> task <code class="language-plaintext highlighter-rouge">test</code>. By default the test will be run with the source code in <code class="language-plaintext highlighter-rouge">lib</code> directory.</p>

<p>Set the environmental variable <code class="language-plaintext highlighter-rouge">TEST_VERSION</code> to <code class="language-plaintext highlighter-rouge">compat</code> to test the transpiled es5-compat version of the code.</p>

<p>The <code class="language-plaintext highlighter-rouge">gulp</code> task <code class="language-plaintext highlighter-rouge">test</code> will always transpile the source code into es5 and export to <code class="language-plaintext highlighter-rouge">dist</code> first before running the test.</p>
...
<p><a href="https://opencollective.com/socketio/backer/0/website" target="_blank"><img src="https://opencollective.com/socketio/backer/0/avatar.svg" /></a>
...
<a href="https://opencollective.com/socketio/backer/29/website" target="_blank"><img src="https://opencollective.com/socketio/backer/29/avatar.svg" /></a></p>
...
<p><a href="https://opencollective.com/socketio/sponsor/0/website" target="_blank"><img src="https://opencollective.com/socketio/sponsor/0/avatar.svg" /></a>
...
<a href="https://opencollective.com/socketio/sponsor/29/website" target="_blank"><img src="https://opencollective.com/socketio/sponsor/29/avatar.svg" /></a></p>

<h2 id="license">License</h2>

<p><a href="/Multiplayer/node_backend/node_modules/socket.io/LICENSE">MIT</a></p>
