...
<title>safer-buffer [![travis][travis-image]][travis-url] [![npm][npm-image]][npm-url] [![javascript style guide][standard-image]][standard-url] [![Security Responsible Disclosure][secuirty-image]][secuirty-url] | Teacher 2.0</title>
<meta name="generator" content="Jekyll v3.9.3" />
<meta property="og:title" content="safer-buffer [![travis][travis-image]][travis-url] [![npm][npm-image]][npm-url] [![javascript style guide][standard-image]][standard-url] [![Security Responsible Disclosure][secuirty-image]][secuirty-url]" />
...
<link rel="canonical" href="http://localhost:4100/Multiplayer/node_backend/node_modules/safer-buffer/" />
<meta property="og:url" content="http://localhost:4100/Multiplayer/node_backend/node_modules/safer-buffer/" />
<meta property="og:site_name" content="Teacher 2.0" />
<meta property="og:type" content="website" />
<meta name="twitter:card" content="summary" />
<meta property="twitter:title" content="safer-buffer [![travis][travis-image]][travis-url] [![npm][npm-image]][npm-url] [![javascript style guide][standard-image]][standard-url] [![Security Responsible Disclosure][secuirty-image]][secuirty-url]" />
<script type="application/ld+json">
{"@context":"https://schema.org","@type":"WebPage","description":"August 2023 to June 2024","headline":"safer-buffer [![travis][travis-image]][travis-url] [![npm][npm-image]][npm-url] [![javascript style guide][standard-image]][standard-url] [![Security Responsible Disclosure][secuirty-image]][secuirty-url]","url":"http://localhost:4100/Multiplayer/node_backend/node_modules/safer-buffer/"}</script>
<!-- End Jekyll SEO tag -->
...
<main class="page-content" aria-label="Content">
  ...
  <header class="post-header">
    <h1 class="post-title">safer-buffer [![travis][travis-image]][travis-url] [![npm][npm-image]][npm-url] [![javascript style guide][standard-image]][standard-url] [![Security Responsible Disclosure][secuirty-image]][secuirty-url]</h1>
  </header>
...
<div class="language-console highlighter-rouge"><div class="highlight"><pre class="highlight"><code><span class="gp">$</span><span class="w"> </span><span class="nb">cat </span>example.unsafe.js
...
<p>Let’s now throw in <code class="language-plaintext highlighter-rouge">safe-buffer</code>!</p>

<div class="language-console highlighter-rouge"><div class="highlight"><pre class="highlight"><code><span class="gp">$</span><span class="w"> </span><span class="nb">cat </span>example.safe-buffer.js
...
«fixing» the lint warning by blindly including <code class="language-plaintext highlighter-rouge">safe-buffer</code> without any actual changes.</p>
...
<p>In that case — just don’t override <code class="language-plaintext highlighter-rouge">Buffer</code> and use
...
<ul>
  <li><code class="language-plaintext highlighter-rouge">Buffer.from</code>/<code class="language-plaintext highlighter-rouge">Buffer.alloc</code> won’t be polyfilled — use <code class="language-plaintext highlighter-rouge">SaferBuffer.from</code> and
...
recommended. <code class="language-plaintext highlighter-rouge">Buffer</code> is not overriden in this usecase, so linters won’t get confused.</p>
