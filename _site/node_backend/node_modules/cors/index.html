...
<link rel="canonical" href="http://localhost:4100/Multiplayer/node_backend/node_modules/cors/" />
<meta property="og:url" content="http://localhost:4100/Multiplayer/node_backend/node_modules/cors/" />
<meta property="og:site_name" content="Teacher 2.0" />
<meta property="og:type" content="website" />
<meta name="twitter:card" content="summary" />
<meta property="twitter:title" content="cors" />
<script type="application/ld+json">
{"@context":"https://schema.org","@type":"WebPage","description":"August 2023 to June 2024","headline":"cors","url":"http://localhost:4100/Multiplayer/node_backend/node_modules/cors/"}</script>
<!-- End Jekyll SEO tag -->
...
<div class="language-sh highlighter-rouge"><div class="highlight"><pre class="highlight"><code><span class="nv">$ </span>npm <span class="nb">install </span>cors
</code></pre></div></div>
...
<span class="kd">var</span> <span class="nx">whitelist</span> <span class="o">=</span> <span class="p">[</span><span class="dl">'</span><span class="s1">http://example1.com</span><span class="dl">'</span><span class="p">,</span> <span class="dl">'</span><span class="s1">http://example2.com</span><span class="dl">'</span><span class="p">]</span>
<span class="kd">var</span> <span class="nx">corsOptions</span> <span class="o">=</span> <span class="p">{</span>
...
<span class="nx">app</span><span class="p">.</span><span class="kd">get</span><span class="p">(</span><span class="dl">'</span><span class="s1">/products/:id</span><span class="dl">'</span><span class="p">,</span> <span class="nx">cors</span><span class="p">(</span><span class="nx">corsOptions</span><span class="p">),</span> <span class="kd">function</span> <span class="p">(</span><span class="nx">req</span><span class="p">,</span> <span class="nx">res</span><span class="p">,</span> <span class="nx">next</span><span class="p">)</span> <span class="p">{</span>
  <span class="nx">res</span><span class="p">.</span><span class="nx">json</span><span class="p">({</span><span class="na">msg</span><span class="p">:</span> <span class="dl">'</span><span class="s1">This is CORS-enabled for a whitelisted domain.</span><span class="dl">'</span><span class="p">})</span>
<span class="p">})</span>
...
add a <code class="language-plaintext highlighter-rouge">!origin</code> check in the origin function like so:</p>

<div class="language-javascript highlighter-rouge"><div class="highlight"><pre class="highlight"><code><span class="kd">var</span> <span class="nx">corsOptions</span> <span class="o">=</span> <span class="p">{</span>
  <span class="na">origin</span><span class="p">:</span> <span class="kd">function</span> <span class="p">(</span><span class="nx">origin</span><span class="p">,</span> <span class="nx">callback</span><span class="p">)</span> <span class="p">{</span>
    <span class="k">if</span> <span class="p">(</span><span class="nx">whitelist</span><span class="p">.</span><span class="nx">indexOf</span><span class="p">(</span><span class="nx">origin</span><span class="p">)</span> <span class="o">!==</span> <span class="o">-</span><span class="mi">1</span> <span class="o">||</span> <span class="o">!</span><span class="nx">origin</span><span class="p">)</span> <span class="p">{</span>
      <span class="nx">callback</span><span class="p">(</span><span class="kc">null</span><span class="p">,</span> <span class="kc">true</span><span class="p">)</span>
    <span class="p">}</span> <span class="k">else</span> <span class="p">{</span>
      <span class="nx">callback</span><span class="p">(</span><span class="k">new</span> <span class="nb">Error</span><span class="p">(</span><span class="dl">'</span><span class="s1">Not allowed by CORS</span><span class="dl">'</span><span class="p">))</span>
    <span class="p">}</span>
...
<code class="language-plaintext highlighter-rouge">OPTIONS</code> request (called the “pre-flight request”). An example of a
...
<span class="nx">app</span><span class="p">.</span><span class="nx">options</span><span class="p">(</span><span class="dl">'</span><span class="s1">/products/:id</span><span class="dl">'</span><span class="p">,</span> <span class="nx">cors</span><span class="p">())</span> <span class="c1">// enable pre-flight request for DELETE request</span>
<span class="nx">app</span><span class="p">.</span><span class="nx">del</span><span class="p">(</span><span class="dl">'</span><span class="s1">/products/:id</span><span class="dl">'</span><span class="p">,</span> <span class="nx">cors</span><span class="p">(),</span> <span class="kd">function</span> <span class="p">(</span><span class="nx">req</span><span class="p">,</span> <span class="nx">res</span><span class="p">,</span> <span class="nx">next</span><span class="p">)</span> <span class="p">{</span>
  <span class="nx">res</span><span class="p">.</span><span class="nx">json</span><span class="p">({</span><span class="na">msg</span><span class="p">:</span> <span class="dl">'</span><span class="s1">This is CORS-enabled for all origins!</span><span class="dl">'</span><span class="p">})</span>
<span class="p">})</span>
...
<div class="language-javascript highlighter-rouge"><div class="highlight"><pre class="highlight"><code><span class="nx">app</span><span class="p">.</span><span class="nx">options</span><span class="p">(</span><span class="dl">'</span><span class="s1">*</span><span class="dl">'</span><span class="p">,</span> <span class="nx">cors</span><span class="p">())</span> <span class="c1">// include before other routes</span>
</code></pre></div></div>
...
<span class="kd">var</span> <span class="nx">whitelist</span> <span class="o">=</span> <span class="p">[</span><span class="dl">'</span><span class="s1">http://example1.com</span><span class="dl">'</span><span class="p">,</span> <span class="dl">'</span><span class="s1">http://example2.com</span><span class="dl">'</span><span class="p">]</span>
<span class="kd">var</span> <span class="nx">corsOptionsDelegate</span> <span class="o">=</span> <span class="kd">function</span> <span class="p">(</span><span class="nx">req</span><span class="p">,</span> <span class="nx">callback</span><span class="p">)</span> <span class="p">{</span>
  <span class="kd">var</span> <span class="nx">corsOptions</span><span class="p">;</span>
  <span class="k">if</span> <span class="p">(</span><span class="nx">whitelist</span><span class="p">.</span><span class="nx">indexOf</span><span class="p">(</span><span class="nx">req</span><span class="p">.</span><span class="nx">header</span><span class="p">(</span><span class="dl">'</span><span class="s1">Origin</span><span class="dl">'</span><span class="p">))</span> <span class="o">!==</span> <span class="o">-</span><span class="mi">1</span><span class="p">)</span> <span class="p">{</span>
    <span class="nx">corsOptions</span> <span class="o">=</span> <span class="p">{</span> <span class="na">origin</span><span class="p">:</span> <span class="kc">true</span> <span class="p">}</span> <span class="c1">// reflect (enable) the requested origin in the CORS response</span>
  <span class="p">}</span> <span class="k">else</span> <span class="p">{</span>
    <span class="nx">corsOptions</span> <span class="o">=</span> <span class="p">{</span> <span class="na">origin</span><span class="p">:</span> <span class="kc">false</span> <span class="p">}</span> <span class="c1">// disable CORS for this request</span>
  <span class="p">}</span>
  <span class="nx">callback</span><span class="p">(</span><span class="kc">null</span><span class="p">,</span> <span class="nx">corsOptions</span><span class="p">)</span> <span class="c1">// callback expects two parameters: error and options</span>
<span class="p">}</span>

<span class="nx">app</span><span class="p">.</span><span class="kd">get</span><span class="p">(</span><span class="dl">'</span><span class="s1">/products/:id</span><span class="dl">'</span><span class="p">,</span> <span class="nx">cors</span><span class="p">(</span><span class="nx">corsOptionsDelegate</span><span class="p">),</span> <span class="kd">function</span> <span class="p">(</span><span class="nx">req</span><span class="p">,</span> <span class="nx">res</span><span class="p">,</span> <span class="nx">next</span><span class="p">)</span> <span class="p">{</span>
  <span class="nx">res</span><span class="p">.</span><span class="nx">json</span><span class="p">({</span><span class="na">msg</span><span class="p">:</span> <span class="dl">'</span><span class="s1">This is CORS-enabled for a whitelisted domain.</span><span class="dl">'</span><span class="p">})</span>
<span class="p">})</span>
...
<ul>
  <li><code class="language-plaintext highlighter-rouge">origin</code>: Configures the <strong>Access-Control-Allow-Origin</strong> CORS header. Possible values:
    <ul>
  ...
  <li><code class="language-plaintext highlighter-rouge">methods</code>: Configures the <strong>Access-Control-Allow-Methods</strong> CORS header. Expects a comma-delimited string (ex: ‘GET,PUT,POST’) or an array (ex: <code class="language-plaintext highlighter-rouge">['GET', 'PUT', 'POST']</code>).</li>
  <li><code class="language-plaintext highlighter-rouge">allowedHeaders</code>: Configures the <strong>Access-Control-Allow-Headers</strong> CORS header. Expects a comma-delimited string (ex: ‘Content-Type,Authorization’) or an array (ex: <code class="language-plaintext highlighter-rouge">['Content-Type', 'Authorization']</code>). If not specified, defaults to reflecting the headers specified in the request’s <strong>Access-Control-Request-Headers</strong> header.</li>
  <li><code class="language-plaintext highlighter-rouge">exposedHeaders</code>: Configures the <strong>Access-Control-Expose-Headers</strong> CORS header. Expects a comma-delimited string (ex: ‘Content-Range,X-Content-Range’) or an array (ex: <code class="language-plaintext highlighter-rouge">['Content-Range', 'X-Content-Range']</code>). If not specified, no custom headers are exposed.</li>
  <li><code class="language-plaintext highlighter-rouge">credentials</code>: Configures the <strong>Access-Control-Allow-Credentials</strong> CORS header. Set to <code class="language-plaintext highlighter-rouge">true</code> to pass the header, otherwise it is omitted.</li>
  <li><code class="language-plaintext highlighter-rouge">maxAge</code>: Configures the <strong>Access-Control-Max-Age</strong> CORS header. Set to an integer to pass the header, otherwise it is omitted.</li>
  <li><code class="language-plaintext highlighter-rouge">preflightContinue</code>: Pass the CORS preflight response to the next handler.</li>
